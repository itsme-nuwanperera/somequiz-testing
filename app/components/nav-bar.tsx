...
export const NavBar = () => {
  ...
  return (
    ...
    >
      <div className="flex max-w-7xl items-center justify-between px-4- mx-auto">
        ...
        <div className="flex items-center gap-4">
          ...
          <div
            ...
            } md:hidden fixed inset-0 mt-16 bg-zinc-950 bg-opacity-90-`}
          >
            <div className="flex justify-between items-center gap-2 bg-zinc-900 px-6 py-4">
